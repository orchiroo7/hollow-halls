...
| | |
|---|---|
| [`hollow_halls_25d/`](hollow_halls_25d) | A 3D world that looks 2D. Two flat views, a free orbit, and a camera that reveals the trick as it moves between them. **152 automated checks.** |
